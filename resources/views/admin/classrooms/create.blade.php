        ...
        <div class="max-w-7xl mx-auto">
            <div class="form-content">
                ...
                <div class="form-header">
                    ...
                    <div class="form-subtitle">Atur identitas kelas dan titik lokasi presensi siswa (Geofencing).</div>
                </div>
                    ...
                    <div class="form-layout">
                        <div class="input-grid-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input" placeholder="Contoh: XII-RPL-1" required autofocus>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="info-box">
                                <div style="display: flex; gap: 10px; align-items: start;">
                                    ...
                                    <span>
                                        <strong>Tips:</strong> Cari lokasi menggunakan ikon 🔍. Pastikan <strong>pin biru</strong> berada tepat di tengah area kelas/sekolah. Siswa hanya bisa absen jika berada dalam radius yang ditentukan.
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-submit">
                                <i class="fa-solid fa-location-dot"></i> Simpan Data Kelas
                            </button>
                        </div>
                    </div>
                </form>
