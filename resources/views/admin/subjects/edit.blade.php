        ...
        <div class="max-w-7xl mx-auto">
            <div class="form-content">
                ...
                <div class="form-header">
                    <div class="form-title">Perbarui Data Mapel</div>
                    <div class="form-subtitle">Ubah informasi mata pelajaran sesuai dengan pembaruan kurikulum</div>
                </div>
                    ...
                    <div class="form-layout">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-submit">
                                <i class="fa-solid fa-rotate"></i> Update Mata Pelajaran
                            </button>
                        </div>
                    </div>
                </form>
